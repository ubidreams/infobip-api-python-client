...
class Network(DefaultObject):
    @property
    @serializable(name="networkName", type='basestring')
    ...
    @property
    @serializable(name="networkPrefix", type='basestring')
    ...
    @property
    @serializable(name="countryName", type='basestring')
    ...
    @property
    @serializable(name="countryPrefix", type='basestring')
