...
class LineData(DefaultObject):
    ...
    @property
    @serializable(name="url", type='basestring')
    def url(self):
        """
    ...
    @property
    @serializable(name="thumbnailUrl", type='basestring')
    ...
    @property
    @serializable(name="duration", type='basestring')
    def duration(self):
        """
        Property is of type: 'basestring'
        """
    ...
    @property
    @serializable(name="packageId", type='basestring')
    def package_id(self):
        """
        Property is of type: 'basestring'
        """
    ...
    @property
    @serializable(name="stickerId", type='basestring')
    def sticker_id(self):
        """
        Property is of type: 'basestring'
        """
