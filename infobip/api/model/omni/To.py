...
class To(DefaultObject):
    @property
    @serializable(name="phoneNumber", type='basestring')
    ...
    @property
    @serializable(name="emailAddress", type='basestring')
    ...
    @property
    @serializable(name="pushRegistrationId", type='basestring')
    ...
    @property
    @serializable(name="facebookUserKey", type='basestring')
    ...
    @property
    @serializable(name="lineUserKey", type='basestring')
